...
export default {
  ...
  // ── Landing page (/) ──
  landing: {
    badge: 'Alpha · open source · zero backend',
    headline: 'Your keys stay on your device. Everything else is open.',
    sub: '7xCircle Wallet is an Apache-2.0 multi-chain wallet with no servers to trust — audit the code, run the build, watch the network tab.',
    ctaOpen: 'Launch Wallet',
    ctaGithub: 'View on GitHub',
    featuresHead: 'What it does',
    f1t: 'Nine chains, one vault',
    f1d: 'Ethereum, BNB, Polygon, Arbitrum, Optimism, Base, Avalanche, Solana and TRON — one mnemonic yields the same addresses as MetaMask, Phantom and TronLink.',
    f2t: 'Keys never leave the device',
    f2d: 'AES-256-GCM vault (PBKDF2, 200k iterations), in-memory sessions, auto-lock. No signup, no servers, no telemetry.',
    f3t: 'Real dApp connections',
    f3d: 'Extension: EIP-1193 + EIP-6963 with per-request approvals. App: WalletConnect v2 with a human review before every signature.',
    f4t: 'Scam shield',
    f4d: 'GoPlus honeypot & tax checks, pre-sign simulation, address-poisoning guards, plus an approval ledger with one-tap revoke.',
    f5t: 'Swap & staking',
    f5d: 'Jupiter-routed Solana swaps with a transparent 0.5% platform fee shown before you sign; JitoSOL / mSOL liquid staking with live APY.',
    f6t: 'Hardware ready',
    f6d: 'Ledger (and OneKey in Ledger mode) over WebUSB on EVM chains — same review-and-sign pipeline as software keys.',
    trustHead: 'Verifiable, not promised',
    t1: 'Apache-2.0 licensed — every line auditable',
    t2: 'Swap fee is 0.5% of the input, shown in the quote and routed on-chain',
    t3: 'SECURITY.md disclosure policy: 48h acknowledgment, 14-day fix for criticals',
    alphaWarn: 'Alpha software, not yet audited — do not store significant funds.',
    getHead: 'Get 7xCircle Wallet',
    getWeb: 'Web app',
    getWebD: 'Runs in any modern browser, right here.',
    getAndroid: 'Android app',
    getAndroidD: 'Debug build v0.1.0 from GitHub Releases.',
    getExt: 'Browser extension',
    getExtD: 'Build from source and load unpacked — guide in the README.',
